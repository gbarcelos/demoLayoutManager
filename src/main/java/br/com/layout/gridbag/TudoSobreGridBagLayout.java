 ...
 * http://www.guj.com.br/java/233211-gridbaglayoutresolvido
 * 
 * @author gustavo.barcelos
 *
 */

public class TudoSobreGridBagLayout extends JFrame  {
	public TudoSobreGridBagLayout() {   
        super("Tudo sobre o GridBagLayout");   
    ...
    public static void main(String[] args ) {   
        TudoSobreGridBagLayout exe = new TudoSobreGridBagLayout();   
        exe.show();         
    }   
