...
public class DefaultWizardProcessModel implements WizardProcessModel {
	...
	/** Creates a new instance of WizardProcessModel */
	public DefaultWizardProcessModel(List panels, String[] steps,
			String[] titles) {
		this.panels = panels;
		this.steps = steps;
		this.titles = titles;
	...
	/**
	 * Returns the next panel in the wizard and increments the selected index.
	 * 
	...
	/**
	 * Returns the previous panel in the wizard and decrements the selected
	 * index.
	 * 
