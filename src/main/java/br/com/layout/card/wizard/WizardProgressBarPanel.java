...
public class WizardProgressBarPanel extends JPanel implements ActionListener {
	...
	/**
	 * Sets the text to be appended within the progress info text area as an
	 * error message.
	 * 
	 * @param the
	 *            text to append
	...
	/**
	 * Sets the progress bar's position during the process. A value of -1 will
	 * set the progress bar to its set maximum.
	 * 
	 * @param the
	 *            new process status
	 */
	...
	/**
	 * <p>
	 * Sets the progress bar to track indeterminate values - action of unknown
